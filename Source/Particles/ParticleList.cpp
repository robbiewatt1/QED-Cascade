...
void ParticleList::MonoSource(unsigned int nPart, double mass, double charge, double energy,
...
void ParticleList::LinearSource(unsigned int nPart, double mass, double charge,
							    double energyMin, double energyMax, double deltaPos, 
